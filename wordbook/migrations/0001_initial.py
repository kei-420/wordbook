# Generated by Django 2.1.3 on 2018-11-25 06:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='wordbook.MultipleQuestions')),
                ('taker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_answers', to='wordbook.QuizTaker')),
            ],
        ),
        migrations.CreateModel(
            name='Word',
        ...
        migrations.AddField(
            model_name='question',
            name='game_word',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wordbook.Word'),
        ),
        migrations.AddField(
            model_name='question',
            name='quiz',
        ...
        migrations.AddField(
            ...
            name='quiz',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='completed_quizzes', to='wordbook.Quiz'),
        ),
        migrations.AddField(
            model_name='completedquiz',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='completed_quizzes', to='wordbook.QuizTaker'),
        ),
    ]
